...
class TestStellarBurgersAccountProfilePage:
    ...
    def test_personal_account_personal_account_page_open_from_from_main_page_user_is_logged_in_true(self, login):
        driver = login
    ...
    def test_personal_account_log_out_and_open_login_page_click_on_exit_button_true(self, login):
        driver = login
        driver.find_element(*Locators.PERSONAL_ACCOUNT_BUTTON_MAIN_SCREEN).click()
    ...
    def test_personal_account_constructor_page_opens_from_personal_account_page_click_on_constructor_button_true(self, login):
        driver = login
        driver.find_element(*Locators.PERSONAL_ACCOUNT_BUTTON_MAIN_SCREEN).click()
        WebDriverWait(driver, 5).until(EC.visibility_of_element_located(Locators.TEXT_OF_PAGE_DESCRIPTION))
    ...
    def test_personal_account_constructor_page_opens_from_personal_account_page_click_on_logo_button_true(self, login):
        driver = login
        driver.find_element(*Locators.PERSONAL_ACCOUNT_BUTTON_MAIN_SCREEN).click()
        WebDriverWait(driver, 5).until(EC.visibility_of_element_located(Locators.TEXT_OF_PAGE_DESCRIPTION))
